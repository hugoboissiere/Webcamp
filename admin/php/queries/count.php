...
// if ($_SESSION['auth']['job'] == 1)
	...
	$countCinemaSessions = $dbh->query("SELECT count(id) as count FROM cw_cinema_sessions INNER JOIN cw_cinema_theaters ON cw_cinema_sessions.id = cw_cinema_theaters.id");
